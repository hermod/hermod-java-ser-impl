...
import static com.github.hermod.ser.intmap.impl.IntMapConstants.DEFAULT_BYTE_VALUE;
import static com.github.hermod.ser.intmap.impl.IntMapConstants.DEFAULT_SHORT_VALUE;
import static com.github.hermod.ser.intmap.impl.IntMapConstants.DEFAULT_INT_VALUE;
import static com.github.hermod.ser.intmap.impl.IntMapConstants.DEFAULT_LONG_VALUE;
import static com.github.hermod.ser.intmap.impl.IntMapConstants.DEFAULT_FLOAT_VALUE;
import static com.github.hermod.ser.intmap.impl.IntMapConstants.DEFAULT_DOUBLE_VALUE;
import static com.github.hermod.ser.intmap.impl.IntMapConstants.DEFAULT_STRING_VALUE;
 ...
 * 
 */
public class KeyObjectValueIntMap
    implements ReadWriteIntMapMsg
{
    ...
    public final short getAsShort(final int aKey)
    {
        try
        {
            return (this.types[aKey] == TYPE_BYTE) ? (byte) this.primitiveValues[aKey]
                    : (this.types[aKey] == TYPE_SHORT) ? (short) this.primitiveValues[aKey] : DEFAULT_SHORT_VALUE;
        }
        catch (final ArrayIndexOutOfBoundsException e)
        {
        ...
        try
        {
            return (this.types[aKey] == TYPE_BYTE) ? (byte) this.primitiveValues[aKey]
                    : (this.types[aKey] == TYPE_SHORT) ? (short) this.primitiveValues[aKey]
                            : (this.types[aKey] == TYPE_INT) ? (int) this.primitiveValues[aKey] : DEFAULT_INT_VALUE;
        }
        catch (final ArrayIndexOutOfBoundsException e)
        {
            ...
            return (this.types[aKey] == TYPE_BYTE) ? (byte) this.primitiveValues[aKey]
                    : (this.types[aKey] == TYPE_SHORT) ? (short) this.primitiveValues[aKey]
                            : (this.types[aKey] == TYPE_INT) ? (int) this.primitiveValues[aKey] 
                                    : (this.types[aKey] == TYPE_LONG) ? this.primitiveValues[aKey] : DEFAULT_LONG_VALUE;
        }
        catch (final ArrayIndexOutOfBoundsException e)
        {
    ...
    public final double getAsDouble(final int aKey)
    {
        try
        {
            return (this.types[aKey] == TYPE_DOUBLE) ? Double.longBitsToDouble(this.primitiveValues[aKey]) : DEFAULT_DOUBLE_VALUE;
        }
        catch (final ArrayIndexOutOfBoundsException e)
        {
...
//    }
     ...
     * (non-Javadoc)
     * 
     * @see com.github.hermod.ser.intmap.ReadIntMap#getAsMap(int)
     */
    @Override
     ...
     * (non-Javadoc)
     * 
     * @see com.github.hermod.ser.intmap.ReadIntMap#getKeys()
     */
    @Override
     ...
     * (non-Javadoc)
     * 
     * @see com.github.hermod.ser.intmap.ReadIntMap#getIterator()
     */
    @Override
     ...
     * (non-Javadoc)
     * 
     * @see org.fame.z.intmap.WriteIntMap#set(int, org.fame.z.intmap.IntMapValue)
     */
    @Override
    ...
    public final void readFrom(final byte[] bytes, final int offset, final int length)
    {
        ...
        while (pos < offset + length)
        {
            ...
            else
            {
                ...
                case TYPE_INT:
                    this.primitiveValues[key] = ((bytes[pos++] & 0xFF)) | ((bytes[pos++] & 0xFF) << 8) | ((bytes[pos++] & 0xFF) << 16)
                            | ((bytes[pos++] & 0xFF) << 24);
                    break;
                ...
                case TYPE_LONG:
                    this.primitiveValues[key] = ((bytes[pos++] & 0xFF)) | ((bytes[pos++] & 0xFF) << 8) | ((bytes[pos++] & 0xFF) << 16)
                            | ((bytes[pos++] & 0xFF) << 24) | ((bytes[pos++] & 0xFF) << 32) | ((bytes[pos++] & 0xFF) << 40) | ((bytes[pos++] & 0xFF) << 48) | ((bytes[pos++] & 0xFF) << 56);
                    break;
